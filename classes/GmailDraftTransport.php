...
class GmailDraftTransport implements Swift_Transport
{
    ...
    public function send(Swift_Mime_SimpleMessage $message, &$failedRecipients = null)
    {
        try {
            ...
            $gmailMessage = new Google_Service_Gmail_Draft();

            // Set client to deferred mode
            $this->googleAPI->client->setDefer(true);

            // Resumable upload
            $usersMessages = $this->googleAPI->getServiceGmail()->users_drafts;
